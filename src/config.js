...
export const CONFIG = {
    ...
    ITEMS: {
        ...
        // Equipment — Iron (level 5)
        iron_dagger:    { name: 'Iron dagger',     stackable: false, icon: '🔪', equipSlot: 'weapon', attackBonus: 5, strengthBonus: 3, defenceBonus: 0, attackReq: 5 },
        iron_mace:      { name: 'Iron mace',       stackable: false, icon: '🔨', equipSlot: 'weapon', attackBonus: 6, strengthBonus: 6, defenceBonus: 0, attackReq: 5 },
        iron_sword:     { name: 'Iron sword',      stackable: false, icon: '⚔️', equipSlot: 'weapon', attackBonus: 8, strengthBonus: 6, defenceBonus: 0, attackReq: 5 },
        iron_helm:      { name: 'Iron full helm',  stackable: false, icon: '⛑️', equipSlot: 'head', attackBonus: 0, strengthBonus: 0, defenceBonus: 5, defenceReq: 5 },
        iron_shield:    { name: 'Iron shield',     stackable: false, icon: '🛡️', equipSlot: 'shield', attackBonus: 0, strengthBonus: 0, defenceBonus: 6, defenceReq: 5 },
        iron_chainbody: { name: 'Iron chainbody',  stackable: false, icon: '🫁', equipSlot: 'body', attackBonus: 0, strengthBonus: 0, defenceBonus: 8, defenceReq: 5 },
        iron_platebody: { name: 'Iron platebody',  stackable: false, icon: '🫁', equipSlot: 'body', attackBonus: 0, strengthBonus: 0, defenceBonus: 11, defenceReq: 5 },
        iron_legs:      { name: 'Iron platelegs',  stackable: false, icon: '👖', equipSlot: 'legs', attackBonus: 0, strengthBonus: 0, defenceBonus: 6, defenceReq: 5 },
